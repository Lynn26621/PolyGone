...
namespace PolyGone
{
    internal class LevelSelect : IScene
    {
        ...
        private readonly string[] _levelNames = { "Test Level 1", "Test Level 2", "Test Level 3", "Test Level 4", "Test Level 5", "Back to Menu" };
        private readonly string?[] _levelFiles = { "TestLevel", "TestLevel2", "TestLevel3", "TestLevel4", "TestLevel5", null };
